...
package net.mcreator.pandora.world.biome;
...
public class FlyingIslandsBiome extends PandoraModElements.ModElement {
	@ObjectHolder("pandora:flying_islands")
	public static final CustomBiome biome = null;
	public FlyingIslandsBiome(PandoraModElements instance) {
		super(instance, 18);
	}
	...
	static class CustomBiome extends Biome {
		public CustomBiome() {
			...
			setRegistryName("flying_islands");
